...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      noValidate
    >
      <label className="relative top-[1.2em] pb-6 z-0 mb-6 font-medium text-[#a1a1a1] transition-all duration-200 ease-in-out">
        <input
          {...register("email", {
        ...
        {errors.email && <p role="alert" className="absolute bottom-0 left-0 text-sm text-red-600">{errors.email.message}</p>}
      </label>
